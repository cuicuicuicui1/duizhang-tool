...
const OUR_COMPANY = {
  name: '邯郸市恒信机电设备有限公司',
  address: '河北省邯郸市丛台区人民路 128 号 5 层',
  phone: '0310-88886666',
  contact: '李会计',
};

const UNITS = [
  { key: 'jia', name: '邯郸市甲辰建材有限公司', type: 'customer', account: '应收账款' },
  { key: 'yi', name: '河北乙顺机电设备有限公司', type: 'supplier', account: '应付账款' },
  { key: 'bing', name: '邯郸市丙通物流有限公司', type: 'customer', account: '应收账款' },
];
...
function build() {
  ...
  files.push({
    ...
    text: [
      ...
      '2026-08-01,邯郸市某某商贸有限公司,销售开票,12000.00,0',
      '2026-08-15,邯郸市某某商贸有限公司,收到货款,0,5000.00',
    ].join('\r\n'),
  ...
  files.push({
    ...
    text: [
      ...
      '2026-08-03,邯郸市某某商贸有限公司,销售开票,8000,0',
    ].join('\r\n'),
  ...
  files.push({
    ...
    sheets: {
      '明细账': [
        ['日期', '往来单位', '摘要', '借方金额'],
        ['2026-08-05', '  邯郸市甲辰建材有限公司  ', '销售开票', 1000],
        ['2026-08-06', '邯郸市甲辰建材有限公司', '销售开票', 2000],
        ['2026-08-07', '邯郸市丙通物流有限公司', '运输服务', 3000],
      ],
    },
  ...
  files.push({
    ...
    sheets: {
      '应收账款余额表': [
        ...
        ['邯郸市甲辰建材有限公司', 20000, 210000, 160000, 70000],
        ['邯郸市丙通物流有限公司', 0, 20000, 0, 20000],
        ['邯郸市某某商贸有限公司', 5000, 1000, 2000, 4000],
      ],
    },
